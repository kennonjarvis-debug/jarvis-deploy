  ...
  useEffect(() => {
    async function fetchObservatory() {
      try {
        ...
        if (error || !data) {
          console.error('No observatory found:', error);
          setError('Please create an observatory from your dashboard first.');
          return;
        }
